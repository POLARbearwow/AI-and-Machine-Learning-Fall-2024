...
# PCA 降维后的 K-Means++
labels_pca, kmeans_pca = apply_kmeans(pca_features, n_clusters=3)
...
# 评估 PCA 降维后的聚类
silhouette_pca, ari_pca, nmi_pca = evaluate_clustering(pca_features, labels_pca, y)
print("PCA 降维后的聚类结果:")
...
# PCA 聚类结果
axes[0].scatter(pca_features[:, 0], pca_features[:, 1], c=labels_pca, cmap='viridis', s=50, label='Cluster')
axes[0].scatter(kmeans_pca.cluster_centers_[:, 0], kmeans_pca.cluster_centers_[:, 1], c='red', marker='x', s=200)
axes[0].set_title('K-Means++ on PCA Features')

# Autoencoder 聚类结果
axes[1].scatter(autoencoded_features[:, 0], autoencoded_features[:, 1], c=labels_autoencoder, cmap='viridis', s=50, label='Cluster')
axes[1].scatter(kmeans_autoencoder.cluster_centers_[:, 0], kmeans_autoencoder.cluster_centers_[:, 1], c='red', marker='x', s=200)
axes[1].set_title('K-Means++ on Autoencoder Features')
